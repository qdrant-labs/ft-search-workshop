Target Audience: E-commerce AI practitioners working on product search, recommendations, or RAG. Search engineers, ML engineers, data scientists, and applied AI teams who want better retrieval quality than generic embeddings deliver.
Fine-Tuning AI Search for E-commerce
Alternative title: Building Better Product Search with Fine-Tuned Retrieval Models
...
In this hands-on workshop, you'll build a product search lab around a custom fine-tuned retrieval model trained on realistic e-commerce data. You'll compare a traditional BM25 baseline, a generic embedding model, and a fine-tuned sparse model, then measure the lift with real relevance metrics. You'll also see how the fine-tuned model fits alongside sparse and hybrid search in a production retrieval stack.
...
No pre-work required. Every participant gets a ready-to-use workshop machine with the environment, data, models, and tools already installed.
...
Short Signup Version
Hands-on workshop on fine-tuned retrieval models for e-commerce. Compare BM25, generic embeddings, and a custom fine-tuned model, measure the lift with real relevance metrics, and diagnose the product search failures generic models can't fix.
